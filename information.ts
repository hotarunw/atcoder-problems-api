...
import { Contest, Problem, ContestAndProblem, MergedProblem, ProblemModel } from "./types"
...
export const getContestsAndProblems = () => fetchJson<ContestAndProblem[]>(CONTESTS_AND_PROBLEMS_URL);
